...
>(
  (
    ...
    return (
      <div
        ref={ref}
        className='group peer hidden text-sidebar-foreground md768:block'
        data-state={state}
      ...
      >
        ...
        <div
          className={cn(
            'fixed inset-y-0 z-10 hidden h-svh w-[--sidebar-width] transition-[left,right,width] duration-200 ease-linear md768:flex',
            side === 'left'
    ...
    return (
      <div className='relative w-full'>
        ...
        <Input
          ...
          data-sidebar='input'
          className={cn(
            'h-[52px] w-full bg-sidebar-accent-foreground p-4 shadow-none',
